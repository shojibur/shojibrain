...
exports.listPresetDefinitions = listPresetDefinitions;
exports.getPresetDefinition = getPresetDefinition;
exports.parsePresetInputs = parsePresetInputs;
exports.resolvePresetConfigEntries = resolvePresetConfigEntries;
exports.buildProjectConfig = buildProjectConfig;
exports.buildPresetSummary = buildPresetSummary;
exports.buildPresetGuidanceSection = buildPresetGuidanceSection;
...
function parsePresetInputs(values) {
...
function resolvePresetConfigEntries(requested) {
...
function buildProjectConfig(presets) {
    return {
        schemaVersion: 1,
...
function buildPresetGuidanceSection(presets, type) {
    if (presets.length === 0) {
        return "";
    }
