...
exports.agentsSection = exports.adrTemplate = exports.specTemplate = exports.featureTemplate = exports.currentTemplate = exports.rulesTemplate = exports.architectureTemplate = exports.productTemplate = void 0;
...
## Future
`;
exports.specTemplate = `# Specification: [Feature / Change]
...
## Open Questions
`;
exports.adrTemplate = `# ADR-XXX: [Decision]
...
## Consequences
`;
exports.agentsSection = `## ShojiBrain
